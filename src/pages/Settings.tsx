...
export default function Settings() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const s = await (db as any).getUserSettings(user.id);
  ...
  const saveSettings = async () => {
    ...
    setIsSaving(true);
    try {
      await (db as any).upsertUserSettings(user.id, settings);
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Recibir notificaciones cuando sea hora de tomar
                      medicamentos
                    </p>
                  </div>
                  <input
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-gray-900">
                      Alertas de cuidadores
                    </h4>
                    <p className="text-sm text-gray-600">
                      Notificar a cuidadores si no tomo medicación
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    className="h-5 w-5 text-primary rounded"
                    checked={settings.notifications.caregiver_alerts}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        notifications: {
                          ...s.notifications,
                          caregiver_alerts: e.target.checked,
                        },
                      }))
                    }
                  />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Notificaciones sobre insignias y rachas
                    </p>
                  </div>
                  <input
                    type="checkbox"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="time"
                    value={settings.notifications.start_time}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        notifications: {
                ...
                <div>
                  ...
                  <input
                    type="time"
                    value={settings.notifications.end_time}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        notifications: {
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Solo cuidadores autorizados pueden ver mi información
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    className="h-5 w-5 text-primary rounded"
                    checked={settings.privacy.profile_private}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        privacy: {
                          ...s.privacy,
                          profile_private: e.target.checked,
                        },
                      }))
                    }
                  />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Añadir capa extra de seguridad a mi cuenta
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        privacy: { ...s.privacy, two_factor: e.target.checked },
                      }))
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Recibir alertas sobre nuevos accesos a mi cuenta
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    className="h-5 w-5 text-primary rounded"
                    checked={settings.privacy.share_with_doctors}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        privacy: {
                          ...s.privacy,
                          share_with_doctors: e.target.checked,
                        },
                      }))
                    }
                  />
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Permitir acceso a mi historial médico a profesionales
                    </p>
                  </div>
                  <input
                    type="checkbox"
                    className="h-5 w-5 text-primary rounded"
                    checked={settings.privacy.anonymous_research}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        privacy: {
                          ...s.privacy,
                          anonymous_research: e.target.checked,
                        },
                      }))
                    }
                  />
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  const relationship =
                    prompt("Relación (p.ej., padre, amigo)") || "";
                  if (!email) return;
                  try {
                    const { data: patient } = await db.getUser(user!.id);
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Invita a familiares o amigos para que te ayuden con el
                seguimiento de tus medicaciones.
              </p>
              <button
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <p>
                  • Los cuidadores reciben notificaciones cuando no tomas tus
                  medicamentos
                </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-lg"
                    value={settings.language.app_language}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        language: {
                          ...s.language,
                          app_language: e.target.value,
                        },
                      }))
                    }>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-lg"
                    value={settings.language.date_format}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        language: {
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-lg"
                    value={settings.language.time_format}
                    onChange={(e) =>
                      setSettings((s: any) => ({
                        ...s,
                        language: {
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Personaliza tu experiencia en MediTrack
              </p>
            </div>
          </div>
        </div>
