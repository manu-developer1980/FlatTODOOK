          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Mantente informado sobre tus medicaciones</p>
              </div>
            </div>
            {unreadCount > 0 && (
              <div className="flex items-center gap-3">
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            notifications.map((notification) => (
              <div
                key={notification.id}
                className={`border rounded-lg p-4 transition-all hover:shadow-md ${getNotificationColor(notification.is_read)}`}
              >
